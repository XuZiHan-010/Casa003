    ...
    var populationChart = new Chart(ctx2, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [3485567, 3694820, 3792621, 3898747], // Corrected data
        ...
        options: {
            scales: {
                y: {
                    beginAtZero: false,
                    min: 3400000,  // Set the minimum scale value if needed
                    max: 4000000,  // Set the maximum scale value if needed
                    title: {
                        display: true,
                        text: 'Population'
                    },
                    ticks: {
                        stepSize: 100000,  // Set the step size to 100,000
                        callback: function(value, index, values) {
                            return value.toLocaleString();  // This will add commas for thousandths
                        }
                    }
                },
                x: {
